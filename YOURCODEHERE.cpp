 ...
 */
#define PSU_ID_SUM (933708459+911111111)
...
std::string generateCacheLatencyParams(string halfBackedConfig) {
	...
	printf("%s\n\n", halfBackedConfig.c_str());

	



//this is from utils.cpp get size statments
	//get dl1 size
	...
	unsigned int dl1blocksize = 8
			* (1 << extractConfigPararm(halfBackedConfig, 2));
	int dl1Size = dl1sets * dl1blocksize;
	...
	unsigned int il1blocksize = 8
			* (1 << extractConfigPararm(halfBackedConfig, 2));
	int il1Size = il1sets * il1blocksize;
	...
	if (u2Size == 32768){
		indexU2 = 0;
	}else if (u2Size == 65536){
		indexU2 = 1;
	}else if (u2Size == 131072){
		indexU2 = 2;
	}else if (u2Size == 262144){
		indexU2 = 3;
	}else if (u2Size == 524288){
		indexU2 = 4;
	}else if (u2Size == 1048576){
		indexU2 = 5;
	}
